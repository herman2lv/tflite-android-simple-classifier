    ...
    private fun setupImageClassifier() {
        ...
        val modelName =
            when (currentModel) {
                ...
                MODEL_BSUIR -> "model_bsuir.tflite"
    ...
    fun classify(image: Bitmap, rotation: Int) {
        ...
        val imageProcessor =
            ImageProcessor.Builder()
                .add(ResizeWithCropOrPadOp(200, 200))
                .add(ResizeOp(32, 32, ResizeOp.ResizeMethod.NEAREST_NEIGHBOR))
                .build()
